...
export const STATUS_META: Record<string, StatusMeta> = {
    ...
    IN_MEDIATION: { badge: "border-teal-500/30 bg-teal-500/15 text-teal-300", dot: "bg-teal-400" },
    AWAITING_EVIDENCE: { badge: "border-sky-500/30 bg-sky-500/15 text-sky-300", dot: "bg-sky-400" },
    ...
    RESOLVED_BY_SETTLEMENT: { badge: "border-emerald-500/30 bg-emerald-500/15 text-emerald-300", dot: "bg-emerald-400" },
    ESCALATED: { badge: "border-amber-500/30 bg-amber-500/15 text-amber-300", dot: "bg-amber-400" },
    ESCALATED_TO_HUMAN: { badge: "border-amber-500/30 bg-amber-500/15 text-amber-300", dot: "bg-amber-400" },
}
